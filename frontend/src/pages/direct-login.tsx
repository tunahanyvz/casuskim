  ...
  const handleSubmit = () => {
    ...
    setTimeout(async () => {
      ...
      if (!response || !response.ok || !joinResponse) {
        setError(joinResponse?.error || "Bilinmeyen bir hata oluştu.");
    ...
    <div className="appMount">
      <div className="directLoginContainer">
        <div className="directForm">
          <h2 className="title">CasusKim?</h2>
          <div className="directLoginText">Devam etmek için bir isim giriniz</div>
          <Input
            focusOnStart={true}
            name="name"
