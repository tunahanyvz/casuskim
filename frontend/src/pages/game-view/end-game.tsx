  ...
  return (
    <div>
      <div style={{ marginBottom: "20px", marginTop: "40px" }}>
        <h1 className={classes.preSpy}>Casus:</h1>
        <h1 className={classes.spy}>
          {endGame.revealedSpy ? endGame.revealedSpy.nickname : "Herkes"}
        </h1>
        <br />
        {endGame.guessedLocation ? (
          <div>
            <h2 className={classes.preGuess}>Tahmini:</h2>
            <h2 className={classes.guess}>{endGame.guessedLocation}</h2>
            <br />
          </div>
        ) : null}
        <h3 className={classes.preLocation}>Konum:</h3>
